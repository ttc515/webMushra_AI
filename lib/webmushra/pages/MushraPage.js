...
MushraPage.prototype.renderCanvas = function (_parentId) {
  ...
  canvasContext.fillText("Naturalness", xLetters, YfirstLine - 25);

  // Labels for naturalness scale
  ...
  // Offset for second slider group (sound quality)
  var yOffset = prevScalesHeight + 20;
  ...
  // Header for Sound Quality
  canvasContext.font = "bold 1.3em Calibri";
  canvasContext.textAlign = "center";
  canvasContext.fillText("Sound Quality", xLetters, YfirstLine + yOffset - 25);

  // Labels for sound quality scale
  canvasContext.font = "1.25em Calibri";
