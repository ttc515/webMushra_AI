...
for p = 1:numel(participants)
    ...
    % Get Mandarin familiarity score
    row = strcmp(data.questionaire_uuid, thisP) & ...
          strcmp(data.wm_id, 'lang_fam') & ...
          strcmp(data.responses_stimulus, 'Lang_man');
    ...
    % === Combined (Test 1 + 2) ===
    isAI_Mandarin = (strcmp(data.wm_id, 'mandarin_test_1') | ...
                     strcmp(data.wm_id, 'mandarin_test_2')) & ...
                    endsWith(data.responses_stimulus, '_1') & ...
                    strcmp(data.CorrectAnswer, 'AI') & ...
                    strcmp(data.questionaire_uuid, thisP);

    if any(isAI_Mandarin)
        responses = data.responses_score(isAI_Mandarin);
        identifiedAsAI = responses <= 45;
        acc_combined(p) = sum(identifiedAsAI) / sum(isAI_Mandarin) * 100;
    end

    % === Test 1 ===
    isTest1 = strcmp(data.wm_id, 'mandarin_test_1') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.CorrectAnswer, 'AI') & ...
              strcmp(data.questionaire_uuid, thisP);
    ...
    % === Test 2 ===
    isTest2 = strcmp(data.wm_id, 'mandarin_test_2') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.CorrectAnswer, 'AI') & ...
              strcmp(data.questionaire_uuid, thisP);
...
for i = 1:3
    ...
    ylim([0 100]);
    xlabel('Language Familiarity (Mandarin)');
...
%% Weighted Accuracy (strict confidence, using data.Correct)
...
for p = 1:numel(participants)
    ...
    % Combined
    rows_comb = (strcmp(data.wm_id, 'mandarin_test_1') | ...
                 strcmp(data.wm_id, 'mandarin_test_2')) & ...
                endsWith(data.responses_stimulus, '_1') & ...
                strcmp(data.questionaire_uuid, thisP);
    ...
    % Test 1
    rows_t1 = strcmp(data.wm_id, 'mandarin_test_1') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.questionaire_uuid, thisP);
    ...
    % Test 2
    rows_t2 = strcmp(data.wm_id, 'mandarin_test_2') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.questionaire_uuid, thisP);
...
fprintf('\n**Overall Weighted Identification Accuracy — Mandarin**\n');
