...
for p = 1:numel(participants)
    ...
    % Get English familiarity score
    row = strcmp(data.questionaire_uuid, thisP) & ...
          strcmp(data.wm_id, 'lang_fam') & ...
          strcmp(data.responses_stimulus, 'Lang_eng');
    if any(row)
    ...
    % === Combined ===
    isAI_Eng = (strcmp(data.wm_id, 'english_test_1') | ...
                strcmp(data.wm_id, 'english_test_2')) & ...
               endsWith(data.responses_stimulus, '_1') & ...
               strcmp(data.CorrectAnswer, 'AI') & ...
               strcmp(data.questionaire_uuid, thisP);

    if any(isAI_Eng)
        responses = data.responses_score(isAI_Eng);
        identifiedAsAI = responses <= 45;
        acc_combined(p) = sum(identifiedAsAI) / sum(isAI_Eng) * 100;
    end

    % === Test 1 ===
    isTest1 = strcmp(data.wm_id, 'english_test_1') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.CorrectAnswer, 'AI') & ...
              strcmp(data.questionaire_uuid, thisP);
    ...
    % === Test 2 ===
    isTest2 = strcmp(data.wm_id, 'english_test_2') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.CorrectAnswer, 'AI') & ...
              strcmp(data.questionaire_uuid, thisP);
...
fprintf('\nCombined English AI Correlation: r = %.2f, p = %.3f\n', r_comb, p_comb);
...
for i = 1:3
    ...
    ylim([0 100]);
    xlabel('Language Familiarity (English)');
...
for p = 1:numel(participants)
    ...
    rows_comb = (strcmp(data.wm_id, 'english_test_1') | ...
                 strcmp(data.wm_id, 'english_test_2')) & ...
                endsWith(data.responses_stimulus, '_1') & ...
                strcmp(data.questionaire_uuid, thisP);
    ...
    % Test 1 Weighted Accuracy
    rows_t1 = strcmp(data.wm_id, 'english_test_1') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.questionaire_uuid, thisP);
    ...
    % Test 2 Weighted Accuracy
    rows_t2 = strcmp(data.wm_id, 'english_test_2') & ...
              endsWith(data.responses_stimulus, '_1') & ...
              strcmp(data.questionaire_uuid, thisP);
...
fprintf('\n**Overall Weighted Identification Accuracy — English**\n');
